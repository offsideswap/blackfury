...
/**
 * @title blackfury/erc20/v1/erc20.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/blackfury/erc20/v1/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<V1QueryParamsResponse, RpcStatus>({
      path: `/blackfury/erc20/v1/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @summary Retrieves registered token pairs
   * @request GET:/blackfury/erc20/v1/token_pairs
   */
  queryTokenPairs = (
    query?: {
    ...
    this.request<V1QueryTokenPairsResponse, RpcStatus>({
      path: `/blackfury/erc20/v1/token_pairs`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryTokenPair
   * @summary Retrieves a registered token pair
   * @request GET:/blackfury/erc20/v1/token_pairs/{token}
   */
  queryTokenPair = (token: string, params: RequestParams = {}) =>
    this.request<V1QueryTokenPairResponse, RpcStatus>({
      path: `/blackfury/erc20/v1/token_pairs/${token}`,
      method: "GET",
      format: "json",
      ...params,
    });
