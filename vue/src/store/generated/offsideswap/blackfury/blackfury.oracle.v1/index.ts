...
import { FeederDelegation } from "./module/types/blackfury/oracle/v1/genesis"
import { MissCounter } from "./module/types/blackfury/oracle/v1/genesis"
import { Params } from "./module/types/blackfury/oracle/v1/oracle"
import { AggregateExchangeRatePrevote } from "./module/types/blackfury/oracle/v1/oracle"
import { AggregateExchangeRateVote } from "./module/types/blackfury/oracle/v1/oracle"
import { ExchangeRateTuple } from "./module/types/blackfury/oracle/v1/oracle"
import { RegisterTargetProposal } from "./module/types/blackfury/oracle/v1/oracle"
import { TargetParams } from "./module/types/blackfury/oracle/v1/oracle"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: blackfury.oracle.v1 initialized!')
		...
		async QueryTargets({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new Error('QueryClient:QueryTargets API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryMissCounter({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new Error('QueryClient:QueryMissCounter API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgAggregateExchangeRatePrevote({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new Error('QueryClient:MsgAggregateExchangeRatePrevote API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgAggregateExchangeRateVote({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new Error('QueryClient:MsgAggregateExchangeRateVote API Node Unavailable. Could not perform query: ' + e.message)
		...
		async MsgDelegateFeedConsent({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				throw new Error('QueryClient:MsgDelegateFeedConsent API Node Unavailable. Could not perform query: ' + e.message)
